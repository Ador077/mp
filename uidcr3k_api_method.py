...
def banner():
	os.system("clear")
	print("")
	print("%s\033[1;91m    ____  _   __      ______________  ______"%(M))
	print("%s\033[1;32m   / __ \/ | / /     / ____/  _/ __ \/ ____/"%(M))
	print("%s\033[1;91m  / / / /  |/ /_____/ /_   / // /_/ / __/"%(M))
	print("%s\033[1;34m / /_/ / /|  /_____/ __/ _/ // _, _/ /___"%(M))
	print("%s\x1b[1;35m \____/_/ |_/     /_/   /___/_/ |_/_____/"%(M))
	print("")
	print("%s\033[1;32m╔══════════════════════════════════════════╗"%(Z))
	print("%s          ║%s  Author   : %sACTION-FIRE                 %s║"%(Z,B,M,Z))
	print("%s          ║%s  Facebook : github.com/ACTION-FIRE       %s║"%(Z,B,Z))
